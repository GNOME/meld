...
class MeldPreferences(prefs.Preferences):
    defaults = {
        ...
        "color_inline_bg0" : prefs.Value(prefs.STRING, "LightSteelBlue2"),
        "color_inline_fg0" : prefs.Value(prefs.STRING, "Red"),
        "color_inline_bg1" : prefs.Value(prefs.STRING, "pink1"),
        "color_inline_fg1" : prefs.Value(prefs.STRING, "DarkBlue"),
